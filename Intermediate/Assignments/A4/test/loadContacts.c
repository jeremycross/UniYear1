...
linkCont* displayContact(linkCont* list, int currCont, int * size){ /*This will need to return struct array in actual code*/
...
int main(){
    ...
    contactList = displayContact(contactList, 2, &size);
